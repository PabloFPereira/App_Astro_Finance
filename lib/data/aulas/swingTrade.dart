...
class SwingTrade extends StatefulWidget {
  @override
  _SwingTradeState createState() => _SwingTradeState();
}

class _SwingTradeState extends State<SwingTrade> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Swing Trading - Begginers'),
      ),
      body: Padding(
