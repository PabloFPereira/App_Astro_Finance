...
class OrganizarFinancas extends StatefulWidget {
  @override
  _OrganizarFinancasState createState() => _OrganizarFinancasState();
}

class _OrganizarFinancasState extends State<OrganizarFinancas> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Organize suas Finaças'),
      ),
      body: Padding(
