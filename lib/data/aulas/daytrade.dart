...
class DayTrade extends StatefulWidget {
  @override
  _DayTradeState createState() => _DayTradeState();
}

class _DayTradeState extends State<DayTrade> {
