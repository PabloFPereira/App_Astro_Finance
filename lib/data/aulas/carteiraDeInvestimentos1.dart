...
class CarteiraInvestimentos1 extends StatefulWidget {
  @override
  _CarteiraInvestimentos1State createState() => _CarteiraInvestimentos1State();
}

class _CarteiraInvestimentos1State extends State<CarteiraInvestimentos1> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Montando uma Carteira de Investimento'),
      ),
      body: Padding(
