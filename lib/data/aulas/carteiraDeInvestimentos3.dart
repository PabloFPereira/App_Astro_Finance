...
class CarteiraInvestimentos3 extends StatefulWidget {
  @override
  _CarteiraInvestimentos3State createState() => _CarteiraInvestimentos3State();
}

class _CarteiraInvestimentos3State extends State<CarteiraInvestimentos3> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Como Criar uma boa Carteira de Investimentos'),
      ),
      body: Padding(
