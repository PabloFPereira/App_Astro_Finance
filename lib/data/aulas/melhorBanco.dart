...
class MelhorBanco extends StatefulWidget {
  @override
  _MelhorBancoState createState() => _MelhorBancoState();
}

class _MelhorBancoState extends State<MelhorBanco> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Analise dos Melhores Bancos'),
      ),
      body: Padding(
